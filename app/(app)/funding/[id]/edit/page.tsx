...
import { updateFundingOpportunity } from '@/app/actions/funding'
...
export default async function EditFundingPage({
  ...
  if (!opportunity) redirect('/funding')

  const o = opportunity as FundingOpportunity
  ...
  return (
    <div className="p-8 max-w-xl">
      ...
      <h1 className="mb-6 text-2xl font-bold text-black dark:text-white">Edit Opportunity</h1>
      ...
      <form className="space-y-4">
        ...
        <div className="flex gap-3 pt-2">
          <button
            formAction={updateFundingOpportunity}
